...
namespace BackupsExtra
{
    internal static class Program
    {
        private static void Main()
        {
            ...
            var backup = new ExtraBackup(algo, compressionAlgo, repository, new BaseClearAlgorithm());
            ...
            joba.AddObject(new JobObject(path, "Screenshot 2021-11-22 at 5.58.46 PM.png"));
            joba.CreateRestorePoint();
